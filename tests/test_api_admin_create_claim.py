...
def test_api_admin_companies_presence(app):
    ...
    app.session.get(url='http://localhost:8080/RabotyNET/users/enabled/admin@gmail.com/')
    app.session.post(url="http://localhost:8080/RabotyNET/login",
                     data={"username": "admin@gmail.com", "password": "admin"}, )
    # ses = app.session.auth(url='http://localhost:8080/RabotyNET/login', auth=('admin@gmail.com','admin'))
    data = {"user": {"userId": 1, "login": "admin@gmail.com",
            ...
            "company": {"companyId": 1, "name": "SoftServe", "edrpou": "23456742",
                        ...
                        "address": {"addressId": 3, "country": "Ukraine", "city": "Chernivtsi", "street": "Holovna",
                                    "building": "246", "zipCode": 58000}, "vacancies": [
                    ...
                    {"vacancyId": 11, "description": "Junior ATQC Engineer", "position": "Junior Engineer",
                     "employment": "FULL", "vacancyStatus": "OPEN", "salary": 450, "currency": "USD", "requirements": [
                    ...
                    {"vacancyId": 6, "description": "Senior Angular Developer", "position": "Senior Developer",
                     ...
                     "hotVacancy": "true",
                     "requirements": [{"requirementId": 11, "description": "Experience with any public cloud provider"},
                    ...
                    {"vacancyId": 5, "description": "Middle WebUI Developer", "position": "Middle Developer",
                     ...
                     "hotVacancy": "false",
                     "requirements": [{"requirementId": 10, "description": "Good understanding of the networking"},
                                      {"requirementId": 9,
                    ...
                    {"vacancyId": 1, "description": "Junior Java Developer", "position": "Junior Developer",
                     ...
                     "requirements": [{"requirementId": 1, "description": "Problem-solving skills"},
                        ...
                        "user": {"userId": 2, "login": "cowner@gmail.com",
                                 ...
                                 "enabled": "true"}, "claims": []}, "title": "None", "description": "tgrhh"}
    # req = requests.Session()
    app.session.get("http://localhost:8080/RabotyNET/claims/byCompany/1")
    ...
    response = app.session.post(url='http://localhost:8080/RabotyNET/claims/create', json=data,
                                auth=("admin@gmail.com", "admin"), headers=tmp)
