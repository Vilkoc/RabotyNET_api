...
def test_others_Roma(app):
    ...
    app.get('http://localhost:8080/RabotyNET/claims/byCompany/1')
    app.post('http://localhost:8080/RabotyNET/claims/create', data)
    assert app.request.status_code == 200, "Wrong status code"
    app.get('http://localhost:8080/RabotyNET/claims/byCompany/1')
...
def test_others_Nazar(app):
    ...
    app.put('http://localhost:8080/RabotyNET/pdf/updatePDF', data)
    assert app.request.status_code == 200, "Wrong status code"
